        ...
        const form =
            <div class="setup_page_default_padding">
                ...
                <form method="post" onSubmit={this.handleSubmit} class={`change_setup_border_${this.state.correctBoxCSS}`}>
                    <div class="setup_page_default_padding">
                        <button onClick={this.handleTestConnection} disabled={this.state.disableAll}>Test Name Availability</button>
                    ...
                    <div class="setup_page_default_padding">
                        <button type="submit" disabled={!(this.state.correctBoxCSS === "success")||this.state.disableAll}>
                            {!(this.state.correctBoxCSS === "success") ? "Please Test Availabilty..." : "Submit (Database will be changed on Success)"}
                        </button>
